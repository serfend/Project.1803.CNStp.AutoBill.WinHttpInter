...
namespace tools
{
    public class HTTP
    {
         ...
         *
         */
        public static ServerInfo sendRequestRetry(bool isSSL, int tryCount, string host, int port, string payload, string request, int timeout, string encoding, bool foward_302)
        {
            int count = 0;
        ...
        private static ServerInfo sendHTTPRequest(int count, string host, int port, string payload, string request, int timeout, string encoding, bool foward_302)
        {
        ...
        private static ServerInfo sendHTTPSRequest(int count, string host, int port, string payload, string request, int timeout, string encoding, bool foward_302)
        {
            string index = Thread.CurrentThread.Name + HTTP.index;
            Stopwatch sw = new Stopwatch();
            sw.Start();
